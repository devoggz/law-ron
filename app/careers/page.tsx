      ...
      <div className="max-w-7xl mx-auto  py-16 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-8 space-y-12">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl lg:text-6xl font-bold text-orange">
              <span className="text-teal">Working with us</span> = happier
              Mondays.
            </h1>
            <p className="text-gray-700 font-regular text-lg leading-relaxed">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-semibold text-primary">Our Culture</h2>
          ...
          <section className="space-y-6">
            ...
            <ul className="list-disc font-regular list-inside text-gray-700 space-y-2">
            ...
            <ol className="list-decimal font-regular list-inside text-gray-700 space-y-2">
        ...
        <div className="lg:col-span-4 flex flex-col justify-start items-center gap-6">
          ...
          <div className="bg-gray-50 p-4 shadow-md w-full">
            <h3 className="text-xl font-semibold mb-2">Why Join Us?</h3>
            <p className="text-gray-700 font-regular text-sm leading-relaxed">
